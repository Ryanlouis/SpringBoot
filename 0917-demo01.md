...
<img width="1006" height="247" alt="{7D8E93FB-04F8-486C-ACDB-0372654DB7BC}" src="https://github.com/user-attachments/assets/b2a00ccc-fdef-49b1-92ee-983a506bc156" />
...
public class CourseController {
    ...
    @PostMapping("/course")
    public String handleCourseFormSubmit(@Valid CourseForm f, BindingResult bindingResult) {
...
```
<img width="345" height="271" alt="{7AB92C37-0C39-4B8F-9572-2B02B7C7EF4C}" src="https://github.com/user-attachments/assets/2e0a1919-3ca0-4677-9521-a214d0d9322f" />
<img width="977" height="58" alt="{44E6A140-9C9F-4077-BABE-917BA33C17CB}" src="https://github.com/user-attachments/assets/c384503c-bda6-442a-af19-61ab3d8550e7" />
...
<img width="515" height="331" alt="{214230F0-5AA7-4E4D-B6D7-8DEA322CC30C}" src="https://github.com/user-attachments/assets/e36debe5-1379-4246-b95d-dbd801c91660" />

* 畫面語言變更 (瀏覽器語言設定，最上方的語言)  
<img width="1126" height="534" alt="image" src="https://github.com/user-attachments/assets/0064b2f9-5e63-4b6f-9d8f-9c5888648a61" />
...
```
<img width="339" height="343" alt="{87FD7F06-0CB5-46F1-B35A-E0A8631A1FB2}" src="https://github.com/user-attachments/assets/9ce8ff78-ae86-4c10-96c6-3c36fa085149" />

<img width="446" height="155" alt="{57BDC564-F3D3-4269-9305-AE2B6456DA52}" src="https://github.com/user-attachments/assets/19898400-1fb9-4df1-924c-14320baa2207" />

### Actuator

pom.xml 要檢查有沒有加  
<img width="1179" height="624" alt="2025-09-17 13_57_26-demo1 – pom xml (demo1)" src="https://github.com/user-attachments/assets/1e2c9471-78f6-44d0-8363-86825659b5a0" />
...
<img width="720" height="412" alt="{61FB2F12-6743-4227-A42E-ADBDCD652179}" src="https://github.com/user-attachments/assets/6e69e340-d509-463d-9590-c899ab467cac" />
<img width="743" height="542" alt="{1E1748B7-DD42-42FA-80A7-5421926E7F76}" src="https://github.com/user-attachments/assets/5f19a5d0-ee42-420f-893a-ce59b44ce7ce" />
